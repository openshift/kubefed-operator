...
import (
	...
	operatorv1alpha1 "github.com/pmorie/kubefed-operator/pkg/apis/operator/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1alpha1.Install{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &operatorv1alpha1.Install{},
	})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *operatorv1alpha1.Install) *corev1.Pod {
